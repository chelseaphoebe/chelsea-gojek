    ...
    <>
      ...
      <div className="bg-center bg-cover bg-no-repeat min-h-screen flex flex-col items-center pt-10 px-12 md:px-0">
        ...
        <div id="section3" className="flex flex-col md:flex-row md:mt-20">
          ...
          <div className="md:w-1/3 order-first md:order-none md:h-screen top-0 md:sticky relative bg-[url('/assets/images/bgNews.png')] bg-cover bg-blend-darken flex justify-center items-center flex-col">
