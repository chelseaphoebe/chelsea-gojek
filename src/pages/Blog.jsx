    ...
    <>
      ...
      <div className="bg-center bg-cover bg-no-repeat min-h-screen flex flex-col items-center pt-10 px-12 md:px-0">
        ...
        <div className="flex flex-wrap justify-center gap-8 pt-8 pb-12 w-full">
          <BlogCard
            imageUrl="/public/assets/images/blog1.png"
          ...
          />
          <BlogCard
            imageUrl="/public/assets/images/blog2.png"
          ...
          />
          <BlogCard
            imageUrl="/public/assets/images/blog3.png"
          ...
          />
          <BlogCard
            imageUrl="/public/assets/images/blog4.png"
          ...
          />
          <BlogCard
            imageUrl="/public/assets/images/blog7.png"
          ...
          />
          <BlogCard
            imageUrl="/public/assets/images/blog8.png"
          ...
          />
          <BlogCard
            imageUrl="/public/assets/images/blog9.png"
        ...
        <div id="section3" className="flex flex-col md:flex-row md:mt-20">
          ...
          <div className="md:w-1/3 order-first md:order-none md:h-screen top-0 md:sticky relative bg-[url('/public/assets/images/bgNews.png')] bg-cover bg-blend-darken flex justify-center items-center flex-col">
